                    ...
                    <div>
                        ...
                        <tbody>
                            <tr v-for="pipa in pipas" :key="pipa.id">
                                ...
                                <v-btn fab dark color="#0B7F9C" dark small fab @click="formEditar(pipa.id, pipa.salesperson_id, pipa.capacity, pipa.niv, 
                                pipa.brand, pipa.model)"><v-icon>mdi-pencil</v-icon></v-btn>

                                <v-btn fab dark color="#0B7F9C" fab dark small @click="borrar(pipa.id) "><v-icon>mdi-delete</v-
                                icon></v-btn>

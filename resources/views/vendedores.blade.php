                    ...
                    <div>
                        ...
                        <tbody>
                            <tr v-for="vendedor in vendedores" :key="vendedor.id">
                                ...
                                <v-btn fab dark color="#0B7F9C" dark small fab @click="formEditar(vendedor.id, vendedor.name, vendedor.lastname, vendedor.birthdate, 
                                vendedor.phone, vendedor.address, vendedor.nss, vendedor.email, vendedor.password)"><v-icon>mdi-pencil</v-icon></v-btn>

                                <v-btn fab dark color="#0B7F9C" fab dark small @click="borrar(vendedor.id) "><v-icon>mdi-delete</v-
                                icon></v-btn>

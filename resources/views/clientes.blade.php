                    ...
                    <div>
                        ...
                        <tbody>
                            <tr v-for="cliente in clientes" :key="cliente.id">
                                ...
                                <v-btn fab dark color="#0B7F9C" dark small fab @click="formEditar(cliente.id, cliente.name, cliente.paternal_surname, cliente.maternal_surname, 
                                cliente.address, cliente.phone)"><v-icon>mdi-pencil</v-icon></v-btn>

                                <v-btn fab dark color="#0B7F9C" fab dark small @click="borrar(cliente.id) "><v-icon>mdi-delete</v-
                                icon></v-btn>
